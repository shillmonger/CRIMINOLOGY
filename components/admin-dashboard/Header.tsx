...
export default function AdminHeader({ setSidebarOpen }: HeaderProps) {
  ...
  return (
    <header className="h-20 border-b border-border flex items-center justify-between gap-4 px-4 sm:px-10 bg-background/80 backdrop-blur-md sticky top-0 z-50">
      ...
      <div className="flex items-center gap-3 flex-shrink-0">
        ...
        <div className="space-y-0.5">
          <h2 className="text-lg md:text-2xl font-black uppercase tracking-tighter italic leading-none text-foreground">
      ...
      <div className="flex items-center gap-2 sm:gap-6 flex-shrink-0">
        ...
        {/* Profile Section (Matching User Header exactly) */}
